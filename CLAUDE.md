...
| Session coach chat (`/api/chat/session`) | `claude-opus-4-7` |
| General coach chat (`/api/chat`) | `claude-opus-4-7` |
| Daily briefing (`lib/claude/briefing.ts`) | `claude-opus-4-7` |
| Dossier synthesis (`lib/claude/dossier.ts`) | `claude-opus-4-7` |
| Plan chat (`/api/chat/plan`) | `claude-opus-4-7` |
